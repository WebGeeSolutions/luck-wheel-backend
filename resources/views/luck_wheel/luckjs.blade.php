...
let theWheel = new Winwheel({
    ...
    'numSegments': {{$promos->count()}},         // Specify number of segments.
    'responsive': true,
    'segments':             // Define segments including colour and text.
        [                               // font size and test colour overridden on backrupt segments.

        @foreach ($promos as $promo)
         { 'fillStyle': '{{$promo->fillStyle}}', 'text': '{{$promo->text}}', 'textFontSize': {{$promo->textFontSize}}, 'textFillStyle': '{{$promo->textFillStyle}}' },
        @endforeach
...
function alertPrize(indicatedSegment) {
    ...
    if (indicatedSegment.text == 'LOOSE TURN') {
        ...
        Swal.fire({
            title: 'Congrats!',
            text: 'You have won ' + indicatedSegment.text + 'Use this promo code: ' + indicatedSegment.promocode,
            imageUrl: 'win.gif',
            imageWidth: 400,
            imageHeight: 200,
